...
@php 
                use App\UtilsVentas;
                $tamColum=UtilsVentas::getTamColumExcel();
                $ip=0;
           @endphp
...
<font size='06'>
           <style>
            ...
            style="border-collapse:collapse; border: black 1px solid">
                <thead height='10' style="border: black 1px solid;">
                <tr align="center" style="vertical-align: middle; background: #AAAAAA; border: back 1px solid">
                <th {!!UtilsVentas::getStyle($tamColum[$ip++])!!} height='40' rowspan="2" >ESPECI FICACION</th>
            ...
            style="border-collapse:collapse; border: back 1px solid">
                ...
                @endforeach
                <tr align="center" style="background: #FFFFFF;border: back 1px solid">
                    <td {!!UtilsVentas::getStyle(UtilsVentas::sum(array($ip++,$ip++,$ip++,$ip++,$ip++,$ip++,$ip++,$ip++))."px")!!} colspan="8" >TOTAL</td>
